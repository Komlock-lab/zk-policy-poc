...
<svg viewBox="0 0 892 400" style="width:100%;height:auto;max-height:390px" role="img" aria-label="開発時、ポリシー設定時、送金時の3段階を左から右へ読むZKアーキテクチャ"><defs><marker id="zk-three-arrow" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="6" markerHeight="6" orient="auto"><path d="M0 0 L10 5 L0 10Z" fill="#7dd3fc"/></marker></defs><g style="font-family:Hiragino Sans,sans-serif" stroke-width="1.4"><text x="117" y="15" text-anchor="middle" style="font-size:13px" fill="#7dd3fc">① 開発時：証明・検証の仕組みを用意</text><g fill="#192734" stroke="#7dd3fc"><circle cx="12" cy="44" r="7"/><path d="M12 51 v20 m-10 -12 h20 m-10 12 l-8 12 m8 -12 l8 12" fill="none"/></g><text x="64" y="55" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">開発者</text><text x="64" y="75" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">条件を記述</text><g fill="#192734" stroke="#7dd3fc"><rect x="165" y="32" width="165" height="57" rx="10"/></g><text x="247.5" y="55" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">Noir回路</text><text x="247.5" y="75" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">コンパイル → ACIR</text><g fill="#192734" stroke="#7dd3fc"><rect x="393" y="32" width="190" height="57" rx="10"/></g><text x="488" y="55" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">Barretenberg</text><text x="488" y="75" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">UltraHonkのVK・Solidity生成</text><g fill="#192734" stroke="#7dd3fc"><rect x="712" y="32" width="178" height="57" rx="0"/><rect x="716" y="36" width="170" height="49"/></g><text x="801" y="55" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">Verifier</text><text x="801" y="75" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">オンチェーンに配置</text><path d="M110 62 H165" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="137.5" y="54" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">回路</text><path d="M330 62 H393" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="361.5" y="54" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">ACIR</text><path d="M583 62 H712" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="647.5" y="54" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">開発者がデプロイ</text><text x="370" y="108" text-anchor="middle" style="font-size:11px" fill="#d1dbe5">ACIRを証明バックエンドにも配置</text><path d="M0 119 H892" stroke="#405366"/><g v-click="1"><text x="122" y="139" text-anchor="middle" style="font-size:13px" fill="#7dd3fc">② ポリシー設定時：ルールを固定</text><g fill="#192734" stroke="#7dd3fc"><circle cx="12" cy="165" r="7"/><path d="M12 172 v20 m-10 -12 h20 m-10 12 l-8 12 m8 -12 l8 12" fill="none"/></g><text x="64" y="176" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">人（Owner）</text><text x="64" y="196" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">ルールを設定</text><g fill="#192734" stroke="#7dd3fc"><rect x="192" y="153" width="205" height="57" rx="10"/></g><text x="294.5" y="176" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">ポリシーレイヤー</text><text x="294.5" y="196" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">Poseidon2でcommitment生成</text><g fill="#192734" stroke="#7dd3fc"><circle cx="501" cy="165" r="7"/><path d="M501 172 v20 m-10 -12 h20 m-10 12 l-8 12 m8 -12 l8 12" fill="none"/></g><text x="556.5" y="176" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">人（Owner）</text><text x="556.5" y="196" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">登録Txに署名</text><g fill="#192734" stroke="#7dd3fc"><rect x="712" y="153" width="178" height="57" rx="0"/><rect x="716" y="157" width="170" height="49"/></g><text x="801" y="176" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">Smart Account</text><text x="801" y="196" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">commitmentを保存</text><path d="M110 183 H192" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="151" y="175" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">ポリシー</text><path d="M397 183 H489" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="443" y="175" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">commitment</text><path d="M606 183 H712" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="659" y="175" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">登録Tx</text><text x="295" y="229" text-anchor="middle" style="font-size:11px" fill="#d1dbe5">秘密のポリシー + salt をバックエンドに保存</text></g><path d="M0 241 H892" stroke="#405366"/><g v-click="2"><text x="111" y="262" text-anchor="middle" style="font-size:13px" fill="#7dd3fc">③ 送金時：適合を証明して実行</text><g fill="#192734" stroke="#7dd3fc"><circle cx="12" cy="294" r="7"/><path d="M12 301 v20 m-10 -12 h20 m-10 12 l-8 12 m8 -12 l8 12" fill="none"/></g><text x="47" y="305" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">人</text><text x="47" y="325" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">送金指示</text><g fill="#192734" stroke="#7dd3fc"><rect x="123" y="282" width="87" height="57" rx="10"/></g><text x="166.5" y="305" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">AI</text><text x="166.5" y="325" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">ツール呼出し</text><g fill="#192734" stroke="#7dd3fc"><rect x="277" y="282" width="213" height="57" rx="10"/></g><text x="383.5" y="305" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">ポリシーレイヤー MCP</text><text x="383.5" y="325" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">Barretenbergでproofを生成</text><g fill="#192734" stroke="#7dd3fc"><rect x="562" y="282" width="152" height="57" rx="0"/><rect x="566" y="286" width="144" height="49"/></g><text x="638" y="305" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">Smart Account</text><text x="638" y="325" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">実行内容から公開入力を構成</text><g fill="#192734" stroke="#7dd3fc"><rect x="795" y="282" width="95" height="57" rx="0"/><rect x="799" y="286" width="87" height="49"/></g><text x="842.5" y="305" text-anchor="middle" style="font-size:14px" fill="#f1f5f9">Verifier</text><text x="842.5" y="325" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">proofを検証</text><path d="M76 312 H123" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="99.5" y="304" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">指示</text><path d="M210 312 H277" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="243.5" y="304" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">金額・宛先</text><path d="M490 312 H562" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="526" y="304" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">proof・送金</text><path d="M714 302 H795" stroke="#7dd3fc" fill="none" marker-end="url(#zk-three-arrow)"/><text x="754.5" y="294" text-anchor="middle" style="font-size:10px;font-weight:500" fill="#7dd3fc">proof・公開入力</text><path d="M795 328 H714" stroke="#7dd3fc" marker-end="url(#zk-three-arrow)"/><text x="754" y="345" text-anchor="middle" style="font-size:10px" fill="#7dd3fc">検証結果</text><text x="383" y="357" text-anchor="middle" style="font-size:10px" fill="#d1dbe5">入力：配置済み回路・秘密のポリシー・現在の状態</text><text x="638" y="369" text-anchor="middle" style="font-size:12px" fill="#7dd3fc">成功 → 送金</text></g><text x="446" y="396" text-anchor="middle" style="font-size:10px" fill="#c3cfdc"></text></g></svg>
