...
- Safe Moduleではなく自作 Smart Account を選んだ理由と、先行実装 [zk-bound](https://github.com/br-to/zk-bound) との関係は [ADR-0016](docs/adr/adr-0016-custom-smart-account-over-safe-module.md) を参照する
