...
| ID | Task | Status |
| --- | --- | --- |
| [task-06-10-01](../../tasks/story-06-10/task-06-10-01-codex-tool-configuration.md) | Codexの3決済Tool設定 | pending |
| [task-06-10-02](../../tasks/story-06-10/task-06-10-02-codex-multi-policy-e2e.md) | 実Codexの複合Policy決済E2E | pending |
